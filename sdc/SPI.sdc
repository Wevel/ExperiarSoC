...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_miso[0]}]
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_miso[1]}]
...
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_clk[0]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_clk[1]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_cs[0]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_cs[1]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_en[0]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_en[1]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_mosi[0]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {spi_mosi[1]}]
###############################################################################
# Environment
###############################################################################
...
set_load -pin_load 0.0334 [get_ports {spi_clk[1]}]
set_load -pin_load 0.0334 [get_ports {spi_clk[0]}]
set_load -pin_load 0.0334 [get_ports {spi_cs[1]}]
set_load -pin_load 0.0334 [get_ports {spi_cs[0]}]
set_load -pin_load 0.0334 [get_ports {spi_en[1]}]
set_load -pin_load 0.0334 [get_ports {spi_en[0]}]
set_load -pin_load 0.0334 [get_ports {spi_mosi[1]}]
set_load -pin_load 0.0334 [get_ports {spi_mosi[0]}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {spi_miso[1]}]
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {spi_miso[0]}]
