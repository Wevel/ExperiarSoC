...
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_en[0]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_en[1]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_en[2]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_en[3]}]
...
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_tx[0]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_tx[1]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_tx[2]}]
set_output_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {uart_tx[3]}]
###############################################################################
# Environment
###############################################################################
...
set_load -pin_load 0.0334 [get_ports {uart_en[3]}]
set_load -pin_load 0.0334 [get_ports {uart_en[2]}]
set_load -pin_load 0.0334 [get_ports {uart_en[1]}]
set_load -pin_load 0.0334 [get_ports {uart_en[0]}]
...
set_load -pin_load 0.0334 [get_ports {uart_tx[3]}]
set_load -pin_load 0.0334 [get_ports {uart_tx[2]}]
set_load -pin_load 0.0334 [get_ports {uart_tx[1]}]
set_load -pin_load 0.0334 [get_ports {uart_tx[0]}]
