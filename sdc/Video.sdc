...
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {sram0_csb0}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {sram0_csb1}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {sram1_csb0}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {sram1_csb1}]
...
set_load -pin_load 0.0334 [get_ports {sram1_csb0}]
set_load -pin_load 0.0334 [get_ports {sram1_csb1}]
