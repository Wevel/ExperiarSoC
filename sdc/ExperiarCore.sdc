...
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {csb0}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {csb1}]
...
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {probe_errorCode[2]}]
set_output_delay 5.0000 -clock [get_clocks {wb_clk_i}] -add_delay [get_ports {probe_errorCode[3]}]
...
set_load -pin_load 0.0334 [get_ports {probe_errorCode[3]}]
set_load -pin_load 0.0334 [get_ports {probe_errorCode[2]}]
