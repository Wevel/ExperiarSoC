...
set ::env(DESIGN_NAME) WishboneInterconnect

set ::env(VERILOG_FILES) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$script_dir/../../verilog/rtl/WishboneInterconnect/WishboneInterconnect_top.v \
	$script_dir/../../verilog/rtl/WishboneInterconnect/WishboneMultiMasterSlave.v \
	$script_dir/../../verilog/rtl/WishboneInterconnect/MasterArbiter.v"
